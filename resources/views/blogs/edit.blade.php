    ...
    <section>
        <div class="mb-8">
            <a href="javascript:history.back()"
                class="inline-flex items-center text-gray-700 hover:text-gray-900 group" title="Go Back">
        ...
        <div class="container mx-auto mt-8">
            ...
            <form action="/blogs/{{ $blog->id }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="flex justify-center">
                    <div class="mb-8 w-[200px] ring-2 ring-gray-600" id="imagePreviewContainer">
